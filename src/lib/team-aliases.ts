 ...
 *           soccer_germany_dfb_pokal, soccer_italy_serie_a, soccer_italy_coppa_italia,
 *           soccer_netherlands_eredivisie, soccer_france_ligue_one, soccer_brazil_campeonato,
...
export const ODDS_TO_ESPN_ABBREV: Record<string, Record<string, string>> = {
  ...
  // DFB-Pokal mirrors the Bundesliga abbreviations for top-flight clubs, with one
  // cross-competition divergence: ESPN uses KSV for Holstein Kiel in the cup (vs
  // KIE in Bundesliga). Also includes common 2. Bundesliga / 3. Liga clubs that
  // routinely feature in the cup. Very-lower-tier amateur clubs fall through to fuzzy.
  soccer_germany_dfb_pokal: {
    ...
    "Heidenheim": "HDH",
    "FC Heidenheim": "HDH",
    // KSV in DFB-Pokal (ESPN), not KIE as in Bundesliga
    "Holstein Kiel": "KSV",
    "Kiel": "KSV",
    "FC St. Pauli": "STP",
    "St. Pauli": "STP",
    ...
    "FC Cologne": "KOE",
    "Cologne": "KOE",
    // Lower-division clubs commonly in DFB-Pokal
    "Hertha Berlin": "BSC",
    "Hertha BSC": "BSC",
