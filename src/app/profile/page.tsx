...
export default async function ProfilePage() {
  ...
  const pendingPvpCount = pvpGold.counts.open + pvpGold.counts.matched + pvpTc.counts.open + pvpTc.counts.matched;
    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-text-muted">Your betting stats</p>
        </div>
      </div>
      ...
      <Section title="Bet Slips — Pending">
        <StatGrid cols={3}>
          ...
          <div className="rounded-xl border border-border/50 p-3 bg-bg-tertiary space-y-1 flex flex-col">
            ...
            <Link href="/tickets" className="text-xs text-odds-green hover:text-odds-green-dim transition-colors mt-auto">
              View My Slips →
            </Link>
          </div>
        </StatGrid>
      ...
      <Section title="PvP Bets — Pending">
        <StatGrid cols={3}>
          ...
          <div className="rounded-xl border border-border/50 p-3 bg-bg-tertiary space-y-1 flex flex-col">
            ...
            <p className="text-xl font-bold font-mono text-gold">{pvpGold.counts.matched + pvpTc.counts.matched}</p>
            <Link href="/bets" className="text-xs text-odds-green hover:text-odds-green-dim transition-colors mt-auto">
              View PvP Bets →
            </Link>
          </div>
        </StatGrid>
